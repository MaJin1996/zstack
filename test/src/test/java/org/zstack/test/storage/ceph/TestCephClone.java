...
import org.zstack.storage.primary.imagestore.ceph.*;
...
public class TestCephClone {
    ...
    public void test() throws ApiSenderException {
        ...
        BackupStorageInventory bs  = new CephCommitImageBackupStorageSelector().selectWithVolume(vol);
        Assert.assertTrue("ps should not be connected or enabled",bs == null);
